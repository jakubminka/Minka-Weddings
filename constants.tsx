...
import { fixObjectTypography } from './utils/typography';

/**
 * ZDE UPRAVUJTE VEŠKERÉ TEXTY NA STRÁNCE
 */
const RAW_SITE_TEXTS = {
  hero: {
...
const RAW_PRICING_PACKAGES: PricingPackage[] = [
  {
    name: 'Essential',
    price: '20 000 Kč',
    hours: '8h natáčení',
...
const RAW_VIDEO_PROJECTS: VideoProject[] = [
  {
    id: '1',
    title: 'Monika & Štěpán',
...
// Aplikujeme typografickou opravu hromadně na všechny exporty
export const SITE_TEXTS = fixObjectTypography(RAW_SITE_TEXTS);
export const PRICING_PACKAGES = fixObjectTypography(RAW_PRICING_PACKAGES);
export const FAQ_DATA = fixObjectTypography(RAW_FAQ_DATA);
export const VIDEO_PROJECTS = fixObjectTypography(RAW_VIDEO_PROJECTS);
export const OTHER_PROJECTS = fixObjectTypography(RAW_OTHER_PROJECTS);

export const LEGAL_CONTENT = fixObjectTypography({
  vop: {
